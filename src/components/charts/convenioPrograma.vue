  ...
  <BCard no-body>
    <BCardBody>
      <BCardTitle class="text-center"
        >Convenios por Programa Académico</BCardTitle
      >
...
import { CONVENIOS_POR_PROGRAMA_ACADEMICO } from "@/constants/urls";
...
const getData = async () => {
  loading.value = true;
  try {
    const response = await apiClient.get(CONVENIOS_POR_PROGRAMA_ACADEMICO);
